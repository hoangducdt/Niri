...
readonly BLUE='\e[38;2;0;150;255m'     # Xanh dương
...
# Global variable to store selected compositor
COMPOSITOR_CHOICE=""
...
# ===== COMPOSITOR-SPECIFIC INSTALLATIONS =====
...
main() {
    ...
    # Get compositor choice
    get_compositor_choice
    
    # Show banner with selected compositor
    show_banner
    ...
    # Compositor-specific installation
    if [ "$COMPOSITOR_CHOICE" = "niri" ]; then
        setup_niri
        setup_dms
